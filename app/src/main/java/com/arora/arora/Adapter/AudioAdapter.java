...
public class AudioAdapter extends RecyclerView.Adapter<AudioAdapter.CustomViewHolder> implements Filterable {
...
//    Audio_item_1 audio_item_1 = new Audio_item_1();
    ...
    //생성자
    public AudioAdapter(Context context, List<Audio_item> list){
        this.arrayList = list;
...
//    Log.i("COUNT",count+"");
    ...
    public void onBindViewHolder(@NonNull final CustomViewHolder customViewHolder, final int i) {
        ...
        Uri albumArtUri = ContentUris.withAppendedId(artworkUri,arrayList.get(i).getAlbumId());
            ...
            customViewHolder.subtitle.setSelected(true);
...
//            this.subtitle = (TextView) view.findViewById(R.id.albumartist);
            ...
            this.subtitle = (TextView)view.findViewById(com.arora.arora.R.id.item_subtitle);
